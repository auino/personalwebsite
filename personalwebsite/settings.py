...
ADMINS = (
    ('Enrico Cambiaso', 'enrico.cambiaso@gmail.com'),
)
...
SECRET_KEY = 'm6_95weo!x7xtoz22-g3tj1e0p=y*c3erkmt@yhzmcm&amp;4%vd41'
...
print SETTINGS_PATH
print os.path.join(PROJECT_PATH, 'app/templates')
